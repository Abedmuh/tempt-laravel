...
<div class="d-flex justify-content-center">
  <div class="card w-50">
    <div class="card-body">
      ...
      <!-- Vertical Form -->
      <form class="row g-3" action="/loker/post" method="POST">
        @csrf
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="link" class="form-control" id="category" required>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="link" class="form-control" placeholder="https:/maps.google.com" id="maps" required>
        </div>
        <div class="col-12">
